...
const baseWidth = 10;
const rangeWidth = 25;
const baseHue = 180;  // Cyan to start (cosmic colors)
const rangeHue = 120; // Wide range: cyan -> blue -> purple -> pink
const baseTTL = 50;
const rangeTTL = 120;
...
const yOff = 0.0015;
const zOff = 0.0015;
const backgroundColor = '#1a1a2e'; // New cosmic background
...
function drawRay(x, y1, y2, life, ttl, width, hue) {
  ...
  gradient.addColorStop(0.5, `hsla(${hue},100%,70%,${fadeInOut(life, ttl) * 0.8})`);
